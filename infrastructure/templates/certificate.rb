SparkleFormation.new(:certificate_dns_validation) do
  description 'Creates the CNAME record to validate an ACM SSL certificate via DNS validation,
  given the name/value DNS validation in params generated by a script'
